                    	...
                    	<div class="intro-y box mt-5 lg:mt-0">
                            <div class="relative flex items-center p-5">
                                <div class="ml-4 mr-auto">
                                    ...
                                    <div class="text-slate-500">
                                    	<strong><u>Agence Origine</u></strong> : <br> {{ $package->agence_origine_id ? $package->agence_origine->libelle : 'Non defini' }}
                                    </div>
                                    <div class="text-slate-500">
                                    	<strong><u>Agence Destination</u></strong> : <br> {{ $package->agence_destination_id ? $package->agence_destination->libelle : 'Non defini' }}
                                    </div>
