			...
			<div class="col-span-12 2xl:col-span-12">
                ...
                <div class="grid grid-cols-12 gap-12 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview" class="btn btn-primary shadow-md mr-2">Nouveau Pays</a>
						...
						<div id="large-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
						    <div class="modal-dialog modal-lg">
						         <div class="modal-content">
						         	<form method="POST" action="{{ route('adminAddPays') }}">
						         		@csrf
						             <!-- BEGIN: Modal Header -->
                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <div class="w-56 relative text-slate-500">
                            	<form id="search-pays" action="{{ route('adminSearchPays') }}" method="GET" class="d-none">
                            		@csrf
                                	<input type="text" name="q" class="form-control w-56 box pr-10" placeholder="Recherche...">
                                	<a href="" onclick="event.preventDefault(); document.getElementById('search-pays').submit();">
                            ...
                            <tbody>
                            	...
                            	@if($countries)
	                                ...
	                                <tr class="intro-x">
	                                    <td class="w-40">
	                                        <div class="flex text-center">
	                                            <div class="w-10 h-10 image-fit zoom-in text-center">
	                                            	...
	                                            	<a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#flag-{{ $country->id }}">
		                                                <img class="rounded-full text-center" src="{{ $country->flag }}">
		                                            </a>
	                                                @else
	                                                <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#flag-{{ $country->id }}">
		                                                <img class="rounded-full text-center" src="{{ URL::to('avatars/avatar.jpg') }}">
		                                            </a>
	                                                @endif
	                                    ...
	                                    <td class="table-report__action w-56">
	                                        <div class="flex justify-center items-center">
	                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#update-{{ $country->id }}"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> </a>
	                                        </div>
	                                    </td>
	                                </tr>
						            ...
						            <div id="update-{{ $country->id }}" class="modal" tabindex="-1" aria-hidden="true">
						                <div class="modal-dialog modal-lg">
									         <div class="modal-content">
									         	<form method="POST" action="{{ route('adminEditPays') }}">
									         		@csrf
									             <!-- BEGIN: Modal Header -->
									             <div class="modal-header">
									             ...
									             <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
									                 <div class="col-span-12 sm:col-span-6"> 
									                 	<input type="hidden" name="pays_id" value="{{ $country->id }}"> 
									                 	<label for="modal-form-1" class="form-label">Code</label> 
									                 	<input type="text" class="form-control" placeholder="GA" name="code" value="{{ $country->code }}"> 
									                 </div>

									                 <div class="col-span-12 sm:col-span-6"> 
									                 	<label for="modal-form-2" class="form-label">Libelle</label> 
									                 	<input type="text" class="form-control" placeholder="GABON" name="libelle" value="{{ $country->libelle }}"> 
									                 </div>
						            ...
						            <div id="flag-{{ $country->id }}" class="modal" tabindex="-1" aria-hidden="true">
						                <div class="modal-dialog modal-lg">
									         <div class="modal-content">
									         	<form method="POST" action="{{ route('adminFlagPays') }}" enctype="multipart/form-data">
									         		@csrf
									             <!-- BEGIN: Modal Header -->
									             <div class="modal-header">
									                 <h2 class="font-medium text-base mr-auto">Formulaire de Modification</h2> 
