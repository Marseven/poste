        ...
        <div class="grid grid-cols-12 gap-12 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview"
                    class="btn btn-primary shadow-md mr-2">Nouvelle Plage</a>
                ...
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <form id="search-forfait" action="{{ route('adminSearchForfait') }}" method="GET" class="d-none">
                            ...
                            <a href=""
                                onclick="event.preventDefault(); document.getElementById('search-forfait').submit();">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                                data-tw-target="#update-{{ $forfait->id }}"> <i data-lucide="edit"
                                                ...
                                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="P05"
                                                            name="code" value="{{ $forfait->code }}">
                                                    </div>

                                                    <div class="col-span-12 sm:col-span-6">
                                                        <label for="modal-form-2" class="form-label">Libelle</label>
                                                        <input type="text" class="form-control" placeholder="PETIT"
                                                            name="libelle" value="{{ $forfait->libelle }}">
                                                    </div>
