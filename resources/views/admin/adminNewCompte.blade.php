                            ...
                            <div class="relative flex items-center p-5">
                                <div class="ml-4 mr-auto">
                                    ...
                                    <div class="text-slate-500">
                                    	<strong><u>NB</u></strong> : Cher agent, la creation de compte n'est valable que pour les employes et les administrateurs ou superieurs de la societe. Aucun compte client ne doit etre creer a partir de cette interface.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="intro-y box col-span-12 2xl:col-span-6">
                                    ...
                                    <div class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                        ...
                                        <div class="col-span-12 sm:col-span-6">  
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex. paul.ndong@gmail.com" name="email"> 
                                        </div>
                                        <div class="col-span-12 sm:col-span-6">  
                                        ...
                                        <div class="col-span-12 sm:col-span-6">  
                                            ...
                                            <input type="text" class="form-control" placeholder="Ex. +241 74 00 00 01" name="phone" required> 
                                        </div>
                                        <div class="col-span-12 sm:col-span-6"> 
                                            <label for="modal-form-1" class="form-label">Adresse*</label> 
                                            <input type="text" class="form-control" placeholder="Ex. Face CKDO Oloumi" name="adresse" required> 
                                        </div>
                                        <div class="col-span-12 sm:col-span-6"> 
