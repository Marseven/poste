                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <div class="w-56 relative text-slate-500">
                            	<form id="search-compte" action="{{ route('adminSearchCompte') }}" method="GET" class="d-none">
                                	...
                                	<a href="" onclick="event.preventDefault(); document.getElementById('search-compte').submit();">
                            ...
                            <tbody>
                            	...
                            	@if($comptes)
	                                ...
	                                <tr class="intro-x">
	                                    ...
	                                    <td class="table-report__action w-56">
	                                        <div class="flex justify-center items-center">
	                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#update-{{ $compte->id }}"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> </a>
	                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#avatar-{{ $compte->id }}"> <i data-lucide="camera" class="w-4 h-4 mr-1"></i> </a>
	                                        </div>
	                                    </td>
	                                </tr>
									         ...
									         <div class="modal-content">
									             ...
									             <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
									             	...
									             	<div class="col-span-12 sm:col-span-6"> 
			                                            ...
			                                            <input type="text" class="form-control" placeholder="Ex. NDONG" name="noms" required value="{{ $compte->noms }}"> 
			                                        </div>
			                                        <div class="col-span-12 sm:col-span-6"> 
			                                            <label for="modal-form-1" class="form-label">Prenoms*</label> 
			                                            <input type="text" class="form-control" placeholder="Ex. Paul" name="prenoms" required value="{{ $compte->prenoms }}"> 
			                                        </div>
			                                        <div class="col-span-12 sm:col-span-6">  
			                                            <label for="modal-form-1" class="form-label">Email*</label> 
			                                            <input type="text" class="form-control" placeholder="Ex. paul.ndong@gmail.com" name="email" value="{{ $compte->email }}"> 
			                                        </div>
			                                        <div class="col-span-12 sm:col-span-6">  
			                                        ...
			                                        <div class="col-span-12 sm:col-span-6">  
			                                            ...
			                                            <input type="text" class="form-control" placeholder="Ex. +241 74 00 00 01" name="phone" required value="{{ $compte->phone }}"> 
			                                        </div>
			                                        <div class="col-span-12 sm:col-span-6"> 
			                                            <label for="modal-form-1" class="form-label">Adresse*</label> 
			                                            <input type="text" class="form-control" placeholder="Ex. Face CKDO Oloumi" name="adresse" required value="{{ $compte->adresse }}"> 
			                                        </div>
			                                        <div class="col-span-12 sm:col-span-6"> 
			                                        ...
			                                        <div class="col-span-12 sm:col-span-6"> 
			                                            ...
			                                            <select id="modal-form-6" class="form-select" name="agence_id">
			                                                @foreach($agences as $agence)
									                 			...
									                 			<option value="{{ $agence->id }}" selected>{{ $agence->libelle }}</option>
									                 			@else
						            ...
						            <div id="avatar-{{ $compte->id }}" class="modal" tabindex="-1" aria-hidden="true">
						                <div class="modal-dialog modal-lg">
									         <div class="modal-content">
									         	<form method="POST" action="{{ route('adminAvatarCompte') }}" enctype="multipart/form-data">
									         		@csrf
									             <!-- BEGIN: Modal Header -->
									             <div class="modal-header">
									                 <h2 class="font-medium text-base mr-auto">Formulaire de Modification de l'Avatar</h2> 
									             </div> <!-- END: Modal Header -->
									             <!-- BEGIN: Modal Body -->
									             <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
