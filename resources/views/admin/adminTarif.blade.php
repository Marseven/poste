			...
			<div class="col-span-12 2xl:col-span-12">
                ...
                <div class="grid grid-cols-12 gap-12 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview" class="btn btn-primary shadow-md mr-2">Nouveau Tarif</a>
                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <div class="w-56 relative text-slate-500">
                            	<form id="search-tarif" action="{{ route('adminSearchTarif') }}" method="GET" class="d-none">
                                	...
                                	<a href="" onclick="event.preventDefault(); document.getElementById('search-tarif').submit();">
	                                ...
	                                <tr class="intro-x">
	                                    ...
	                                    <td class="table-report__action w-56">
	                                        <div class="flex justify-center items-center">
	                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#update-{{ $tarif->id }}"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> </a>
	                                        </div>
	                                    </td>
	                                </tr>
						                ...
						                <div class="modal-dialog modal-lg">
									         <div class="modal-content">
									             ...
									             <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
									                 ...
									                 <div class="col-span-12 sm:col-span-12"> 
									                 	<input type="hidden" name="forfait_id" value="{{ $tarif->id }}"> 
									                 	<label for="modal-form-1" class="form-label">Code</label> 
									                 	<input type="text" class="form-control" placeholder="P05" name="code" value="{{ $tarif->code }}"> 
									                 </div>
									                 ...
									                 <div class="col-span-12 sm:col-span-4"> 
									                 	...
									                 	<select id="modal-form-6" class="form-select" name="pays_exp">
									                        @foreach($countries as $country)
									                 			...
									                 			<option value="{{ $country->libelle }}" selected>{{ $country->libelle }}</option>
									                 			@else
									                 			<option value="{{ $country->libelle }}">{{ $country->libelle }}</option>
									                 			@endif
									                        @endforeach
									                 ...
									                 <div class="col-span-12 sm:col-span-4"> 
									                 	...
									                 	<select id="modal-form-6" class="form-select" name="province_exp">
									                        @foreach($provinces as $province)
									                 			...
									                 			<option value="{{ $province->libelle }}" selected>{{ $province->libelle }}</option>
									                 			@else
									                 			<option value="{{ $province->libelle }}">{{ $province->libelle }}</option>
									                 			@endif
									                        @endforeach
									                 ...
									                 <div class="col-span-12 sm:col-span-4"> 
									                 	...
									                 	<select id="modal-form-6" class="form-select" name="ville_exp">
									                        @foreach($villes as $ville)
									                 			...
									                 			<option value="{{ $ville->libelle }}" selected>{{ $ville->libelle }}</option>
									                 			@else
									                 			<option value="{{ $ville->libelle }}">{{ $ville->libelle }}</option>
									                 			@endif
									                        @endforeach
									                 ...
									                 <div class="col-span-12 sm:col-span-6"> 
									                 	<label for="modal-form-2" class="form-label">Poids Minimum</label> 
									                 	<input type="number" class="form-control" name="poids_min" value="{{ $tarif->poids_min }}"> 
									                 </div>

									                 <div class="col-span-12 sm:col-span-6"> 
									                 	<label for="modal-form-2" class="form-label">Poids Maximum</label> 
									                 	<input type="number" class="form-control" name="poids_max" value="{{ $tarif->poids_max }}"> 
									                 </div>

									                 <div class="col-span-12 sm:col-span-12"> 
									                 	<label for="modal-form-2" class="form-label">Tarif</label> 
									                 	<input type="number" class="form-control" name="tarif" value="{{ $tarif->tarif }}"> 
									                 </div>
