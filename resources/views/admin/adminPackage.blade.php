			...
			<div class="col-span-12 2xl:col-span-12">
                ...
                <div class="grid grid-cols-12 gap-12 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        ...
                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview" class="btn btn-primary shadow-md mr-2">Nouveau Package</a>
                        ...
                        <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            <div class="w-56 relative text-slate-500">
                            	<form id="search-packages" action="{{ route('adminSearchPackage') }}" method="GET" class="d-none">
                                	...
                                	<a href="" onclick="event.preventDefault(); document.getElementById('search-packages').submit();">
                            	...
                            	@if($packages)
	                                ...
	                                <tr class="intro-x">
	                                    <td class="text-center">
	                                    	<a href="{{ route('adminSuiviPackage', ['code' => $package->code]) }}" class="text-primary" target="_blank">
		                                    	{{ $package->code }}
		                                    </a>
	                                    </td>
	                                    <td class="text-center">
	                                    ...
	                                    <td class="table-report__action w-56">
	                                        <div class="flex justify-center items-center">
	                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal" data-tw-target="#update-{{ $package->id }}"> <i data-lucide="edit" class="w-4 h-4 mr-1"></i> </a>

	                                            <a href="{{ route('adminDetailPackage', ['code' => $package->code]) }}"><i data-lucide="eye" class="w-4 h-4 mr-1"></i></a>
	                                        </div>
	                                    </td>
	                                </tr>
						                ...
						                <div class="modal-dialog modal-lg">
									         <div class="modal-content">
									             ...
									             <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
									                 ...
									                 <div class="col-span-12 sm:col-span-12"> 
									                 	<label for="modal-form-2" class="form-label">Libelle</label> 
									                 	<input type="text" class="form-control" name="libelle" value="{{ $package->libelle }}"> 
									                 </div>
