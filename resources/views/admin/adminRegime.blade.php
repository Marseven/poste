        ...
        <div class="grid grid-cols-12 gap-12 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview"
                    class="btn btn-primary shadow-md mr-2">Nouveau Régime</a>
                ...
                <div id="large-modal-size-preview" class="modal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="POST" action="{{ route('adminAddRegime') }}">
                                @csrf
                                <!-- BEGIN: Modal Header -->
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-4">
                                        <label for="modal-form-6" class="form-label">Type d'axpédition</label>
                                        <select id="modal-form-6" class="form-select" name="type_exp" required>
                ...
                <div class="hidden md:block mx-auto text-slate-500">
                    Affiche de 1 a 10 sur {{ $regimes->count() }} régimes
                </div>
                ...
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <form id="search-tarif" action="{{ route('adminSearchTarif') }}" method="GET" class="d-none">
                            ...
                            <a href=""
                                onclick="event.preventDefault(); document.getElementById('search-regime').submit();">
                    ...
                    <tbody>
                        ...
                        @if ($regimes)
                            @foreach ($regimes as $regime)
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                                data-tw-target="#update-{{ $regime->id }}"> <i data-lucide="edit"
                                ...
                                <div id="update-{{ $regime->id }}" class="modal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form method="POST" action="{{ route('adminEditRegime') }}">
                                                @csrf
                                                <!-- BEGIN: Modal Header -->
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                    ...
                                                    <div class="col-span-12 sm:col-span-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="P05"
                                                            name="code" value="{{ $regime->code }}" required>
                                                    </div>

                                                    <div class="col-span-12 sm:col-span-4">
                                                        <label for="modal-form-6" class="form-label">Type
                                                            d'expéditon</label>
                                                        <select id="modal-form-6" class="form-select" name="type_exp"
                                                            required>
                                                            @foreach ($types as $type)
                                                                @if ($type->id == $regime->type_id)
