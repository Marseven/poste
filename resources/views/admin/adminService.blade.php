        ...
        <div class="grid grid-cols-12 gap-12 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#large-modal-size-preview"
                    class="btn btn-primary shadow-md mr-2">Nouveau Service</a>
                        ...
                        <div class="modal-content">
                            <form method="POST" action="{{ route('adminAddService') }}">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        <label for="modal-form-2" class="form-label">Poids Max (KG)</label>
                                        <input type="number" step="0.01" class="form-control" name="weight_max">
                                    </div>
                ...
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <div class="w-56 relative text-slate-500">
                        <form id="search-service" action="{{ route('adminSearchService') }}" method="GET" class="d-none">
                            ...
                            <a href=""
                                onclick="event.preventDefault(); document.getElementById('search-service').submit();">
                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center whitespace-nowrap">POIDS MAX</th>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            <a class="flex items-center mr-3" href="javascript:;" data-tw-toggle="modal"
                                                data-tw-target="#update-{{ $service->id }}"> <i data-lucide="edit"
                                                ...
                                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <input type="hidden" name="service_id"
                                                            value="{{ $service->id }}">
                                                        <label for="modal-form-1" class="form-label">Code</label>
                                                        <input type="text" class="form-control" placeholder="FRT"
                                                            name="code" value="{{ $service->code }}">
                                                    </div>

                                                    <div class="col-span-12 sm:col-span-6">
                                                        <label for="modal-form-2" class="form-label">Libelle</label>
                                                        <input type="text" class="form-control"
                                                            placeholder="FRET AERIEN" name="libelle"
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <label for="modal-form-2" class="form-label">Poids Max
                                                            (KG)
                                                        </label>
                                                        <input type="number" step="0.01"
                                                            value="{{ $service->weight_max }}" class="form-control"
                                                            name="weight_max">
                                                    </div>
