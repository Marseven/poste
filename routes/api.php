...
Route::get('agence-list', [API\CityController::class, 'getList']);
Route::get('agence-detail', [API\CityController::class, 'getDetail']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('agence-save', [App\Http\Controllers\CityController::class, 'store']);
    Route::post('agence-delete/{id}', [App\Http\Controllers\CityController::class, 'destroy']);
    Route::post('agence-action', [App\Http\Controllers\CityController::class, 'action']);
    ...
    Route::get('bag-list', [API\OrderController::class, 'getList']);
    Route::get('bag-detail', [API\OrderController::class, 'getDetail']);
    Route::post('bag-save', [App\Http\Controllers\OrderController::class, 'store']);
    Route::post('bag-update/{id}', [App\Http\Controllers\OrderController::class, 'update']);
    Route::post('bag-delete/{id}', [App\Http\Controllers\OrderController::class, 'destroy']);
    Route::post('bag-action', [App\Http\Controllers\OrderController::class, 'action']);
